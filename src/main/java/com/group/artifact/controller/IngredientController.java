...
public class IngredientController {
    ...
    public IngredientController(IngredientService ingredientService, IngredientToIngredientCommand convertToIngredientCommand, UOMService uomService, IngredientCommandToIngredient convertToIngredient) {
    ...
    @GetMapping
    @RequestMapping("/recipe/{recipeId}/ingredient/{id}/detail")
