package com.group.artifact.bootstrap;

import com.group.artifact.domain.*;
import com.group.artifact.repository.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    @Transactional //20190101, for lazy initialization exception
    public void onApplicationEvent(ContextRefreshedEvent event) {
        recipeRepository.saveAll(getRecipes());
        log.debug("Bootstrap data is loading");//20190101
    }
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.setDifficulity(Difficulity.MODERATE);
